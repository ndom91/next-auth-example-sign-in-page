    ...
    <main className="flex overflow-hidden flex-col justify-between items-center p-24 min-h-screen">
      <div className="z-10 justify-between items-center w-full max-w-5xl font-mono text-sm lg:flex">
        <form
          action={async () => {
            "use server";
            session?.user ? await signIn() : await signOut();
          }}
        >
          <button
